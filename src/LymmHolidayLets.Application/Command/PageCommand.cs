...
{
    public sealed class PageCommand(IPageRepository pageRepository) : IPageCommand
    {
        public void Create(Page page)
        {
            pageRepository.Create(new Domain.Model.Page.Entity.Page(page.AliasTitle,
        ...
        {
            pageRepository.Update(new Domain.Model.Page.Entity.Page(
