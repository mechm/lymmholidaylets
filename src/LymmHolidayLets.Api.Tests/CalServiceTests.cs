...
public class CalServiceTests
{
    ...
    /// <summary>
    /// Creates a real MemoryCache seeded with the ical-results key if icalList is provided.
    /// </summary>
    ...
    {
        // propertyId 0 is explicitly rejected even though byte allows 0
    ...
    public async Task GetCalendarAsync_CachedCalendar_DoesNotCallGenerator()
    {
        ...
        // Pre-populate the availability cache
